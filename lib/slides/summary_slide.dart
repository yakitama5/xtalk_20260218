...
デザインツール上の絵が全てではなく、その裏にあるニーズを理解することが重要です。

また、違和感は会話のチャンスなので、すぐに会話しましょう。
結末が変わらなかったとしても、その過程で理解が深まり、より良いシステムになります。

そして最後に「作らない勇気」を持つことが、システムと私たちの残業時間を守ります。
            ...
            builder: (context, stepNumber) {
              return Column(
                ...
                children: [
                  ...
                  const Gap(64),
                  _buildBullet(stepNumber, 2, "Figma != ニーズ"),
                  const Gap(24),
      ...
      child: Row(
        ...
        children: [
          Icon(
            Icons.check_circle,
            color: isStrong
                ? PresentationTheme.accentDarkColor
